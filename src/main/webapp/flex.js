...
}(this, (function (exports, core, common, rxjs, operators, coercion, platformBrowser, bidi) {
    'use strict';
...
***************************************************************************** */
    ...
    var StylesheetMap = /** @class */ (function () {
        ...
        /** @nocollapse */ StylesheetMap.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function StylesheetMap_Factory() {
                return new StylesheetMap();
            }, token: StylesheetMap, providedIn: "root"
        });
    ...
    var BreakPointRegistry = /** @class */ (function () {
        ...
        /** @nocollapse */ BreakPointRegistry.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function BreakPointRegistry_Factory() {
                return new BreakPointRegistry(core.ɵɵinject(BREAKPOINTS));
    ...
    var MatchMedia = /** @class */ (function () {
        ...
        function (mediaQuery) {
            ...
            function (query) {
                ...
                function (e) {
                     ...
                     */
                    function () {
                        return _this.source.next(new MediaChange(e.matches, query));
                    }));
                });
                /** @type {?} */
        ...
        /** @nocollapse */ MatchMedia.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function MatchMedia_Factory() {
                return new MatchMedia(core.ɵɵinject(core.NgZone), core.ɵɵinject(core.PLATFORM_ID), core.ɵɵinject(common.DOCUMENT));
            }, token: MatchMedia, providedIn: "root"
        });
        return MatchMedia;
    }());
    /**
    ...
    function buildQueryCss(mediaQueries, _document) {
        ...
        if (list.length > 0) {
            ...
            try {
                 ...
                 */
                function (mq) {
                    return ALL_STYLES[mq] = styleEl_1;
                }));
            } catch (e) {
                console.error(e);
            }
    ...
    var PrintHook = /** @class */ (function () {
        ...
        Object.defineProperty(PrintHook.prototype, "printBreakPoints", {
            ...
            function () {
                ...
                return (/** @type {?} */ (this.printAlias
                     ...
                     */
                    function (alias) {
                        return _this.breakpoints.findByAlias(alias);
                    }))
                    .filter((/**
                     * @param {?} bp
                     * @return {?}
        ...
        /** @nocollapse */ PrintHook.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function PrintHook_Factory() {
                return new PrintHook(core.ɵɵinject(BreakPointRegistry), core.ɵɵinject(LAYOUT_CONFIG));
            }, token: PrintHook, providedIn: "root"
        });
        return PrintHook;
    }());
// ************************************************************************
...
// ************************************************************************
    ...
    var MediaObserver = /** @class */ (function () {
        ...
        function (mqList) {
            ...
            return this.matchMedia
                ...
                })), operators.debounceTime(0, rxjs.asapScheduler), operators.switchMap((/**
                 * @param {?} _
                 * @return {?}
                 */
                function (_) {
                    return rxjs.of(_this.findAllActivations());
                })), operators.map(excludeOverlaps), operators.filter(hasChanges), operators.takeUntil(this.destroyed$));
        };
        /**
        ...
        /** @nocollapse */ MediaObserver.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function MediaObserver_Factory() {
                return new MediaObserver(core.ɵɵinject(BreakPointRegistry), core.ɵɵinject(MatchMedia), core.ɵɵinject(PrintHook));
            }, token: MediaObserver, providedIn: "root"
        });
    ...
    var MediaTrigger = /** @class */ (function () {
        ...
        function (queries, matches) {
             ...
             */
            function (query) {
                return _this.emitChangeEvent(matches, query);
            });
        ...
        /** @nocollapse */ MediaTrigger.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function MediaTrigger_Factory() {
                return new MediaTrigger(core.ɵɵinject(BreakPointRegistry), core.ɵɵinject(MatchMedia), core.ɵɵinject(LAYOUT_CONFIG), core.ɵɵinject(core.PLATFORM_ID), core.ɵɵinject(common.DOCUMENT));
            }, token: MediaTrigger, providedIn: "root"
        });
        return MediaTrigger;
    }());
    ...
    var StyleUtils = /** @class */ (function () {
        ...
        /** @nocollapse */ StyleUtils.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function StyleUtils_Factory() {
                return new StyleUtils(core.ɵɵinject(StylesheetMap, 8), core.ɵɵinject(SERVER_TOKEN, 8), core.ɵɵinject(core.PLATFORM_ID), core.ɵɵinject(LAYOUT_CONFIG));
            }, token: StyleUtils, providedIn: "root"
        });
        return StyleUtils;
    }());
    ...
    var MediaMarshaller = /** @class */ (function () {
            ...
            if (bpMap) {
                ...
                if (valueMap) {
                    if (key) {
                         ...
                         */
                        function (v, k) {
                            return _this.updateElement(element, k, v);
                        }));
                    }
                }
            }
        ...
        /** @nocollapse */ MediaMarshaller.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function MediaMarshaller_Factory() {
                return new MediaMarshaller(core.ɵɵinject(MatchMedia), core.ɵɵinject(BreakPointRegistry), core.ɵɵinject(PrintHook));
            }, token: MediaMarshaller, providedIn: "root"
        });
    ...
    var ImgSrcStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ ImgSrcStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function ImgSrcStyleBuilder_Factory() {
                return new ImgSrcStyleBuilder();
            }, token: ImgSrcStyleBuilder, providedIn: "root"
        });
...
// tslint:disable-next-line:variable-name
    ...
    var DefaultClassDirective = /** @class */ (function (_super) {
        ...
        DefaultClassDirective.decorators = [
            {
                type: core.Directive,
                args: [{selector: selector$1, inputs: inputs$1, providers: [LayoutNgClassImplProvider]},]
            },
        ];
    ...
    var ShowHideStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ ShowHideStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function ShowHideStyleBuilder_Factory() {
                return new ShowHideStyleBuilder();
            }, token: ShowHideStyleBuilder, providedIn: "root"
        });
...
// tslint:disable-next-line:variable-name
    ...
    var DefaultStyleDirective = /** @class */ (function (_super) {
        ...
        DefaultStyleDirective.decorators = [
            {
                type: core.Directive,
                args: [{selector: selector$3, inputs: inputs$3, providers: [LayoutNgStyleImplProvider]},]
            },
        ];
    ...
    var LayoutStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ LayoutStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function LayoutStyleBuilder_Factory() {
                return new LayoutStyleBuilder();
            }, token: LayoutStyleBuilder, providedIn: "root"
        });
    ...
    var LayoutGapStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ LayoutGapStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function LayoutGapStyleBuilder_Factory() {
                return new LayoutGapStyleBuilder(core.ɵɵinject(StyleUtils));
    ...
    var LayoutGapDirective = /** @class */ (function (_super) {
        ...
        function (value) {
            ...
            var items = this.childrenNodes
                 ...
                 */
                function (el) {
                    return el.nodeType === 1 && _this.willDisplay(el);
                }))
                .sort((/**
                 * @param {?} a
                 * @param {?} b
    ...
    var FlexStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ FlexStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function FlexStyleBuilder_Factory() {
                return new FlexStyleBuilder(core.ɵɵinject(LAYOUT_CONFIG));
            }, token: FlexStyleBuilder, providedIn: "root"
        });
    ...
    var FlexOrderStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ FlexOrderStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function FlexOrderStyleBuilder_Factory() {
                return new FlexOrderStyleBuilder();
            }, token: FlexOrderStyleBuilder, providedIn: "root"
        });
    ...
    var FlexOffsetStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ FlexOffsetStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function FlexOffsetStyleBuilder_Factory() {
                return new FlexOffsetStyleBuilder();
            }, token: FlexOffsetStyleBuilder, providedIn: "root"
        });
    ...
    var FlexAlignStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ FlexAlignStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function FlexAlignStyleBuilder_Factory() {
                return new FlexAlignStyleBuilder();
            }, token: FlexAlignStyleBuilder, providedIn: "root"
        });
    ...
    var FlexFillStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ FlexFillStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function FlexFillStyleBuilder_Factory() {
                return new FlexFillStyleBuilder();
            }, token: FlexFillStyleBuilder, providedIn: "root"
        });
    ...
    var LayoutAlignStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ LayoutAlignStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function LayoutAlignStyleBuilder_Factory() {
                return new LayoutAlignStyleBuilder();
            }, token: LayoutAlignStyleBuilder, providedIn: "root"
        });
    ...
    var GridAlignStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ GridAlignStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function GridAlignStyleBuilder_Factory() {
                return new GridAlignStyleBuilder();
            }, token: GridAlignStyleBuilder, providedIn: "root"
        });
    ...
    var GridAlignColumnsStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ GridAlignColumnsStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function GridAlignColumnsStyleBuilder_Factory() {
                return new GridAlignColumnsStyleBuilder();
            }, token: GridAlignColumnsStyleBuilder, providedIn: "root"
        });
    ...
    var GridAlignColumnsDirective = /** @class */ (function (_super) {
        ...
        Object.defineProperty(GridAlignColumnsDirective.prototype, "inline", {
             ...
             */
            function (val) {
                this._inline = coercion.coerceBooleanProperty(val);
            },
            enumerable: true,
            configurable: true
        });
    ...
    var GridAlignRowsStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ GridAlignRowsStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function GridAlignRowsStyleBuilder_Factory() {
                return new GridAlignRowsStyleBuilder();
            }, token: GridAlignRowsStyleBuilder, providedIn: "root"
        });
    ...
    var GridAreaStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ GridAreaStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function GridAreaStyleBuilder_Factory() {
                return new GridAreaStyleBuilder();
            }, token: GridAreaStyleBuilder, providedIn: "root"
        });
    ...
    var GridAreasStyleBuiler = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ GridAreasStyleBuiler.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function GridAreasStyleBuiler_Factory() {
                return new GridAreasStyleBuiler();
            }, token: GridAreasStyleBuiler, providedIn: "root"
        });
    ...
    var GridAutoStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ GridAutoStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function GridAutoStyleBuilder_Factory() {
                return new GridAutoStyleBuilder();
            }, token: GridAutoStyleBuilder, providedIn: "root"
        });
    ...
    var GridColumnStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ GridColumnStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function GridColumnStyleBuilder_Factory() {
                return new GridColumnStyleBuilder();
            }, token: GridColumnStyleBuilder, providedIn: "root"
        });
    ...
    var GridColumnsStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ GridColumnsStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function GridColumnsStyleBuilder_Factory() {
                return new GridColumnsStyleBuilder();
            }, token: GridColumnsStyleBuilder, providedIn: "root"
        });
    ...
    var GridGapStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ GridGapStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function GridGapStyleBuilder_Factory() {
                return new GridGapStyleBuilder();
            }, token: GridGapStyleBuilder, providedIn: "root"
        });
    ...
    var GridRowStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ GridRowStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function GridRowStyleBuilder_Factory() {
                return new GridRowStyleBuilder();
            }, token: GridRowStyleBuilder, providedIn: "root"
        });
    ...
    var GridRowsStyleBuilder = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ GridRowsStyleBuilder.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function GridRowsStyleBuilder_Factory() {
                return new GridRowsStyleBuilder();
            }, token: GridRowsStyleBuilder, providedIn: "root"
        });
