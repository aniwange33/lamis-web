(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('@clr/angular'), require('moduled')) :
        typeof define === 'function' && define.amd ? define('moduleb', ['exports', '@angular/core', '@angular/router', '@clr/angular', 'moduled'], factory) :
            (factory((global.moduleb = {}), global.ng.core, global.ng.router, null, moduled));
}(this, (function (exports, core, router, angular, moduled) {
    'use strict';

    console.log('cfr', moduled.ModuledModule)
    /**
    ...
    /** @nocollapse */ ModulebService.ngInjectableDef = core.defineInjectable({
        ...
        }, token: ModulebService, providedIn: "root"
    });
    /**
     * @fileoverview added by tsickle
     * @suppress {checkTypes} checked by tsc
    ...
    var ModulebComponent = (function () {
        function ModulebComponent(factory) {
        ...
        ModulebComponent.prototype.ngOnInit = function () {
            console.log('Oninit', this.factory);
        };
    ...
    ModulebComponent.ctorParameters = function () {
        return [{type: core.ComponentFactoryResolver}];
    };
    /**
     * @fileoverview added by tsickle
     * @suppress {checkTypes} checked by tsc
