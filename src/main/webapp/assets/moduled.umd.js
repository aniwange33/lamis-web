(function (global, factory) {
    ...
    /** @nocollapse */
    ModuledService.ctorParameters = function () {
        return [];
    };
    /** @nocollapse */ ModuledService.ngInjectableDef = core.defineInjectable({
        factory: function ModuledService_Factory() {
            return new ModuledService();
        }, token: ModuledService, providedIn: "root"
    });
    /**
     * @fileoverview added by tsickle
     * @suppress {checkTypes} checked by tsc
    ...
    /** @nocollapse */
    ComponentaComponent.ctorParameters = function () {
        return [];
    };
    /**
     * @fileoverview added by tsickle
    ...
    /** @nocollapse */
    ComponentbComponent.ctorParameters = function () {
        return [];
    };
    /**
     * @fileoverview added by tsickle
    ...
    /** @nocollapse */
    ComponentcComponent.ctorParameters = function () {
        return [];
    };
    /**
     * @fileoverview added by tsickle
    ...
    var ModuledModule = (function () {
        function ModuledModule() {
            console.log('ModuleD constructor');
        }
            ...
            type: core.NgModule, args: [{
                imports: [
                    router.RouterModule.forChild([
                        {
                            path: '', component: ModuledComponent,
                            children: [
                                {
                                    path: '', redirectTo: 'a'
                                },
