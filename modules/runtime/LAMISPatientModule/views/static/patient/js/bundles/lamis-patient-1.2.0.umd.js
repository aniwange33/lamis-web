(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@lamis/web-core'), require('rxjs/operators'), require('moment'), require('@angular/router'), require('@alfresco/adf-core'), require('@angular/common'), require('@angular/material'), require('@covalent/core'), require('@ng-bootstrap/ng-bootstrap'), require('ng-jhipster'), require('@angular/forms'), require('rxjs'), require('angular-material-formio'), require('ng2-validation')) :
        typeof define === 'function' && define.amd ? define('lamis-patient-1.2.0', ['exports', '@angular/core', '@angular/common/http', '@lamis/web-core', 'rxjs/operators', 'moment', '@angular/router', '@alfresco/adf-core', '@angular/common', '@angular/material', '@covalent/core', '@ng-bootstrap/ng-bootstrap', 'ng-jhipster', '@angular/forms', 'rxjs', 'angular-material-formio', 'ng2-validation'], factory) :
            (global = global || self, factory((global['lamis-patient-1'] = global['lamis-patient-1'] || {}, global['lamis-patient-1']['2'] = global['lamis-patient-1']['2'] || {}, global['lamis-patient-1']['2']['0'] = {}), global.ng.core, global.ng.common.http, global.webCore, global.rxjs.operators, global.moment_, global.ng.router, global.adfCore, global.ng.common, global.ng.material, global.core$1, global.ngBootstrap, global.ngJhipster, global.ng.forms, global.rxjs, global.angularMaterialFormio, global.ng2Validation));
    ...
    ***************************************************************************** */
    ...
    var PatientEditComponent = /** @class */ (function () {
        function PatientEditComponent(patientService, notification, loaderService, activatedRoute, formBuilder) {
            ...
            this.minDateRegistration = moment$2('2008', 'YYYY');
            this.maxDateBirth = moment$2().subtract(2, 'months');
            this.maxDateConfirmed = moment$2();
            this.minDateConfirmed = moment$2('2008', 'YYYY');
        }
        ...
        PatientEditComponent.prototype.dateBirthChanged = function (date) {
            ...
            if (this.minDateRegistration.isBefore(moment$2('2008', 'YYYY'), 'day')) {
                this.minDateRegistration = moment$2('2008', 'YYYY');
                this.minDateConfirmed = moment$2('2008', 'YYYY');
            }
        };
...
//# sourceMappingURL=lamis-patient-1.2.0.umd.js.map
