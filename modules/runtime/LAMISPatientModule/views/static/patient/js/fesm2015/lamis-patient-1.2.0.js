...
import {FormBuilder, NG_ASYNC_VALIDATORS, FormsModule, ReactiveFormsModule} from '@angular/forms';
import {of} from 'rxjs';
...
let PatientEditComponent = class PatientEditComponent {
    constructor(patientService, notification, loaderService, activatedRoute, formBuilder) {
        this.patientService = patientService;
        this.notification = notification;
...
//# sourceMappingURL=lamis-patient-1.2.0.js.map
