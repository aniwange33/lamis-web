(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('lamis-pharmacy-1.4.0', ['exports', '@angular/core', '@angular/common/http', '@lamis/web-core', 'rxjs/operators', 'moment', '@alfresco/adf-core', '@angular/common', '@angular/material', '@angular/router', '@covalent/core', '@swimlane/ngx-datatable', 'rxjs', '@mat-datetimepicker/core', '@angular/forms', 'ng2-validation'], factory) :
    (global = global || self, factory((global['lamis-pharmacy-1'] = global['lamis-pharmacy-1'] || {}, global['lamis-pharmacy-1']['4'] = global['lamis-pharmacy-1']['4'] || {}, global['lamis-pharmacy-1']['4']['0'] = {}), global.ng.core, global.ng.common.http, global.webCore, global.rxjs.operators, global.moment_, global.adfCore, global.ng.common, global.ng.material, global.ng.router, global.core$1, global.ngxDatatable, global.rxjs, global.core$2, global.ng.forms, global.ng2Validation));
}(this, function (exports, core, http, webCore, operators, moment_, adfCore, common, material, router, core$1, ngxDatatable, rxjs, core$2, forms, ng2Validation) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var PharmacyService = /** @class */ (function () {
        ...
        PharmacyService.prototype.convertDateFromClient = function (pharmacy) {
            var copy = Object.assign({}, pharmacy, {
                ...
                nextAppointment: pharmacy.nextAppointment != null && pharmacy.nextAppointment.isValid() ?
                    pharmacy.nextAppointment.format(webCore.DATE_FORMAT) : null
            });
            return copy;
        };
        ...
        PharmacyService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function PharmacyService_Factory() { return new PharmacyService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(webCore.SERVER_API_URL_CONFIG)); }, token: PharmacyService, providedIn: "root" });
                ...
                if (_this.entity.id) {
                    if (_this.entity.extra && _this.entity.extra.ipt) {
                        _this.ipt = Object.assign({}, _this.entity.extra.ipt, {
                            dateCompleted: _this.entity.extra.ipt.dateCompleted != null ? moment$1(_this.entity.extra.ipt.dateCompleted) : null
                        });
                    }
            ...
            if (this.iptSelected && this.ipt) {
                this.entity.extra.ipt = Object.assign({}, this.ipt, {
                    dateCompleted: this.ipt.dateCompleted != null && this.ipt.dateCompleted.isValid() ?
                        this.ipt.dateCompleted.format(webCore.DATE_FORMAT) : null
                });
            }
    ...
    var PharmacyDetailsComponent = /** @class */ (function () {
        ...
        PharmacyDetailsComponent.prototype.buildProperties = function () {
            ...
            this.dataSource = __spread(this.dataSource);
    ...
    var DevolveService = /** @class */ (function () {
        ...
        DevolveService.ctorParameters = function () { return [
            { type: http.HttpClient },
            { type: undefined, decorators: [{ type: core.Inject, args: [webCore.SERVER_API_URL_CONFIG,] }] }
        ]; };
        DevolveService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function DevolveService_Factory() { return new DevolveService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(webCore.SERVER_API_URL_CONFIG)); }, token: DevolveService, providedIn: "root" });
    ...
    var EndDevolveComponent = /** @class */ (function () {
        ...
        EndDevolveComponent.prototype.ngOnInit = function () {
            ...
            this.pharmacyService.getPatient(patientId).subscribe(function (res) {
                _this.pharmacyService.getDevolvement(res.id, moment$5()).subscribe(function (r) {
                    _this.entity = r;
                    if (_this.entity.dateDiscontinued) {
...
//# sourceMappingURL=lamis-pharmacy-1.4.0.umd.js.map
