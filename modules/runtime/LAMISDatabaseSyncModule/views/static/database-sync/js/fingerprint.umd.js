(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common/http'), require('rxjs'), require('sockjs-client'), require('webstomp-client'), require('@angular/core'), require('@angular/material'), require('@angular/flex-layout'), require('@angular/common'), require('@stomp/ng2-stompjs'), require('@angular/platform-browser'), require('@angular/router')) :
        typeof define === 'function' && define.amd ? define('fingerprint', ['exports', '@angular/common/http', 'rxjs', 'sockjs-client', 'webstomp-client', '@angular/core', '@angular/material', '@angular/flex-layout', '@angular/common', '@stomp/ng2-stompjs', '@angular/platform-browser', '@angular/router'], factory) :
            (factory((global.fingerprint = {}), global.ng.common.http, global.rxjs, global.SockJs, global.Stomp, global.ng.core, global.ng.material, global.ng['flex-layout'], global.ng.common, global.ng2Stompjs, global.ng.platformBrowser, global.ng.router));
}(this, (function (exports, i1, rxjs, SockJs, Stomp, i0, material, flexLayout, common, ng2Stompjs, platformBrowser, router) {
    'use strict';
    ...
    var WebsocketService = /** @class */ (function () {
        ...
        function (patient) {
            if (this.stompClient !== null && this.stompClient.connected) {
                this.stompClient.send('/topic/medical/database-status', // destination
                    JSON.stringify({
                        patient: patient
                    }), // body
                    {} // header
        ...
        function () {
            ...
            this.connection.then(function () {
                _this.messageSubscriber = _this.stompClient.subscribe('/topic/database/message', function (data) {
                    _this.messageListenerObserver.next(JSON.parse(data.body));
                });
                _this.deviceSubscriber = _this.stompClient.subscribe('/topic/database/device', function (data) {
                    _this.deviceListenerObserver.next(JSON.parse(data.body));
                });
                _this.fingerSubscriber = _this.stompClient.subscribe('/topic/database/finger', function (data) {
                    _this.fingerListenerObserver.next(JSON.parse(data.body));
                });
                _this.messageSubscriber = _this.stompClient.subscribe('/topic/database/score', function (data) {
    ...
    var FingerprintComponent = /** @class */ (function () {
        function FingerprintComponent(rxStompService, patientService, websocketService) {
            ...
            this.prompt = '';
            this.icon = 'database:default_sensor';
            this.scoreIcon = 'database:score_0';
            this.fingerIcon = 'database:left_index';
         ...
         * @return {?}
         */
        FingerprintComponent.prototype.enableVerify = /**
         * @return {?}
         */
        function () {
            console.log('Verify?', !(!!this.activeReader && !!this.medical));
            return !!this.activeReader && !!this.medical;
        };
        /**
         * @return {?}
         */
        FingerprintComponent.prototype.enableEnrol = /**
         * @return {?}
         */
        function () {
            return !!this.activeReader && !!this.medical && !!this.fingerprint;
        };
        /**
         * @return {?}
         */
        FingerprintComponent.prototype.enableIdentify = /**
         * @return {?}
         */
        function () {
        ...
        function () {
            ...
            // this.websocketService.verify(this.activeReader.serial, this.medical);
        };
        /**
         * @return {?}
         */
        ...
        function () {
            ...
            // this.websocketService.enrol(this.activeReader.serial, this.medical, this.database);
        };
        /**
         * @return {?}
         */
        ...
        function () {
            ...
            // this.websocketService.identify(this.activeReader.serial);
        };
        /**
         * @return {?}
         */
         ...
         */
        function () {
            console.log('Patient', this.medical);
            console.log('Reader', this.activeReader);
            this.rxStompService.publish({
                destination: '/topic/medical/database-status',
                body: JSON.stringify({
                    patient: this.patient
                })
            });
            // this.websocketService.fingerprintStatus(this.medical);
        };
        /**
         * @return {?}
         */
        ...
        function () {
            this.rxStompService.publish({
                destination: '/topic/database/probe-readers',
                body: JSON.stringify({})
            });
            // this.websocketService.probeReaders();
        };
        /**
         * @return {?}
         */
        ...
        function () {
            this.rxStompService.publish({
                destination: '/topic/database/stop-capture',
                body: JSON.stringify({})
            });
        };
        /**
        ...
        function () {
            ...
            this.messageSubscription = this.rxStompService.watch('/topic/database/message')
                .subscribe(function (res) {
                    /** @type {?} */
                    var message = JSON.parse(res.body);
                    _this.prompt = message.message;
                    _this.icon = 'database:' + message.icon;
                    _this.enrolling = false;
                });
            /*this.websocketService.messageReceive().subscribe(res => {
              const message: IMessage = res.body;
              this.prompt = message.message;
              this.icon = message.icon;
              this.enrolling = false;
            });*/
            this.deviceSubscription = this.rxStompService.watch('/topic/database/readers')
            ...
            /*this.websocketService.deviceReceive().subscribe(res => {
              this.readers = res;
              if (this.readers.length === 1) {
                this.activeReader = this.readers[0];
              }
            });*/
            this.fingerSubscription = this.rxStompService.watch('/topic/database/finger')
                .subscribe(function (res) {
                    /** @type {?} */
                    var message = JSON.parse(res.body);
                    _this.prompt = message.message;
                    _this.fingerIcon = 'database:' + message.icon;
                    _this.enrolling = true;
                });
            /*this.websocketService.fingerReceive().subscribe(res => {
              const message: IMessage = res;
              this.prompt = message.message;
              this.fingerIcon = message.icon;
              this.enrolling = true;
            });*/
            this.scoreSubscription = this.rxStompService.watch('/topic/database/score')
                .subscribe(function (res) {
                    /** @type {?} */
                    var message = JSON.parse(res.body);
                    _this.prompt = message.message;
                    _this.scoreIcon = 'database:' + message.icon;
                    _this.enrolling = true;
                });
            this.probeReaders();
            /*this.websocketService.scoreReceive().subscribe(res => {
              const message: IMessage = res;
              this.prompt = message.message;
              this.scoreIcon = message.icon;
              this.enrolling = true;
            });*/
        };
        /**
    ...
    var FingerprintModule = /** @class */ (function () {
        function FingerprintModule(_iconRegistry, _domSanitizer) {
            ...
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'score_0', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/score_0.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'score_1', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/score_1.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'score_2', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/score_2.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'score_3', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/score_3.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'score_4', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/score_4.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'right_index', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/right_index.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'left_index', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/left_index.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'right_thumb', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/right_thumb.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'left_thumb', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/left_thumb.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'touched_sensor', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/touched_sensor.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'default_sensor', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/default_sensor.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'failed_sensor', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/failed_sensor.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'finger_default', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/finger_default.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'finger_disabled', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/finger_disabled.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'finger_matched', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/finger_matched.svg'));
            this._iconRegistry.addSvgIconInNamespace('fingerprint', 'finger_unknown', this._domSanitizer.bypassSecurityTrustResourceUrl('/across/resources/static/database/img/finger_unknown.svg'));
        }
    ...
    exports.ɵd = FingerprintRoutes;
    exports.ɵa = PatientService;
    exports.ɵe = RxStompConfig;
...
//# sourceMappingURL=database.umd.js.map
