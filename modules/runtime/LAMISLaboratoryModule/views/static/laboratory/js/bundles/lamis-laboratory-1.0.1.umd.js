(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@lamis/web-core'), require('rxjs/operators'), require('moment'), require('@alfresco/adf-core'), require('@angular/common'), require('@angular/material'), require('@angular/router'), require('@covalent/core'), require('rxjs'), require('@swimlane/ngx-datatable'), require('@angular/forms'), require('ng2-validation')) :
        typeof define === 'function' && define.amd ? define('lamis-laboratory-1.0.1', ['exports', '@angular/core', '@angular/common/http', '@lamis/web-core', 'rxjs/operators', 'moment', '@alfresco/adf-core', '@angular/common', '@angular/material', '@angular/router', '@covalent/core', 'rxjs', '@swimlane/ngx-datatable', '@angular/forms', 'ng2-validation'], factory) :
            (global = global || self, factory((global['lamis-laboratory-1'] = global['lamis-laboratory-1'] || {}, global['lamis-laboratory-1']['0'] = global['lamis-laboratory-1']['0'] || {}, global['lamis-laboratory-1']['0']['1'] = {}), global.ng.core, global.ng.common.http, global.webCore, global.rxjs.operators, global.moment_, global.adfCore, global.ng.common, global.ng.material, global.ng.router, global.core$1, global.rxjs, global.ngxDatatable, global.ng.forms, global.ng2Validation));
    ...
    var LaboratoryEditComponent = /** @class */ (function () {
        ...
        LaboratoryEditComponent.prototype.ngOnInit = function () {
            ...
            this.activatedRoute.data.subscribe(function (_a) {
                ...
                if (_this.entity.id) {
                    _this.minAssayDate = _this.entity.dateSampleCollected.clone().add(2, 'days');
                    if (_this.entity.dateAssay) {
                        _this.minReportedDate = _this.entity.dateAssay.clone().add(2, 'days');
                    }
...
//# sourceMappingURL=lamis-laboratory-1.0.1.umd.js.map
