(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@lamis/web-core'), require('@stomp/ng2-stompjs'), require('file-saver'), require('@angular/common'), require('@angular/material'), require('@angular/router'), require('@angular/forms'), require('@covalent/core')) :
        typeof define === 'function' && define.amd ? define('fhi-backup', ['exports', '@angular/core', '@angular/common/http', '@lamis/web-core', '@stomp/ng2-stompjs', 'file-saver', '@angular/common', '@angular/material', '@angular/router', '@angular/forms', '@covalent/core'], factory) :
            (global = global || self, factory(global['fhi-backup'] = {}, global.ng.core, global.ng.common.http, global.webCore, global.ng2Stompjs, global.fileSaver, global.ng.common, global.ng.material, global.ng.router, global.ng.forms, global.core$1));
...
//# sourceMappingURL=fhi-backup.umd.js.map
