(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@lamis/web-core'), require('rxjs/operators'), require('moment'), require('@alfresco/adf-core'), require('@angular/common'), require('@angular/material'), require('@angular/router'), require('@covalent/core'), require('@swimlane/ngx-datatable'), require('rxjs'), require('@mat-datetimepicker/core'), require('@angular/forms'), require('ng2-validation'), require('@stomp/ng2-stompjs'), require('@ng-bootstrap/ng-bootstrap')) :
        typeof define === 'function' && define.amd ? define('lamis-clinic-1.1.3', ['exports', '@angular/core', '@angular/common/http', '@lamis/web-core', 'rxjs/operators', 'moment', '@alfresco/adf-core', '@angular/common', '@angular/material', '@angular/router', '@covalent/core', '@swimlane/ngx-datatable', 'rxjs', '@mat-datetimepicker/core', '@angular/forms', 'ng2-validation', '@stomp/ng2-stompjs', '@ng-bootstrap/ng-bootstrap'], factory) :
            (global = global || self, factory((global['lamis-clinic-1'] = global['lamis-clinic-1'] || {}, global['lamis-clinic-1']['1'] = global['lamis-clinic-1']['1'] || {}, global['lamis-clinic-1']['1']['3'] = {}), global.ng.core, global.ng.common.http, global.webCore, global.rxjs.operators, global.moment_, global.adfCore, global.ng.common, global.ng.material, global.ng.router, global.core$1, global.ngxDatatable, global.rxjs, global.core$2, global.ng.forms, global.ng2Validation, global.ng2Stompjs, global.ngBootstrap));
}(this, function (exports, core, http, webCore, operators, moment_, adfCore, common, material, router, core$1, ngxDatatable, rxjs, core$2, forms, ng2Validation, ng2Stompjs, ngBootstrap) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var ClinicService = /** @class */ (function () {
        ...
        ClinicService.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function ClinicService_Factory() {
                return new ClinicService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(webCore.SERVER_API_URL_CONFIG));
    ...
    var ChronicCareService = /** @class */ (function () {
        ...
        ChronicCareService.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function ChronicCareService_Factory() {
                return new ChronicCareService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(webCore.SERVER_API_URL_CONFIG));
    ...
    var EacService = /** @class */ (function () {
        ...
        EacService.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function EacService_Factory() {
                return new EacService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(webCore.SERVER_API_URL_CONFIG));
    ...
    var CaseManagementService = /** @class */ (function () {
        ...
        CaseManagementService.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function CaseManagementService_Factory() {
                return new CaseManagementService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(webCore.SERVER_API_URL_CONFIG));
    ...
    var CaseManagerService = /** @class */ (function () {
        ...
        CaseManagerService.ngInjectableDef = core.ɵɵdefineInjectable({
            factory: function CaseManagerService_Factory() {
                return new CaseManagerService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(webCore.SERVER_API_URL_CONFIG));
...
//# sourceMappingURL=lamis-clinic-1.1.3.umd.js.map
